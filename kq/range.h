...
using rangehelper_t =
	typename std::conditional<
				character_pack::is_integral<c...>::value,
				IntegralRangeHelper<ullong,character_pack::get_integral_value<c...>::value>,
				first_type<RangeHelper<ldouble>>::type>
			::type;
*/
...
/*
constexpr impl::RangeHelper<> operator"" _range(ullong max)
{
	return impl::RangeHelper<>(max);
}

constexpr impl::RangeHelper<ldouble> operator"" _range(ldouble max)
{
	return impl::RangeHelper<ldouble>(max);
}
*/
